  ...
  return (
    ...
    <body>
        <div className="header">
            <div>
                <img className="headshot" src={anthony} 
            ...
            <div className="next-to-headshot">
                <div className="name-in-header">
                    <h1 className="name-in-header">
                        Anthony Cruz Macedo
                    </h1>
                </div>
                <div>
                    <p>
                        <a className="link" href="https://www.facebook.com/profile.php?id=100072821919133">Facebook</a> <a className="link" href="https://www.instagram.com/saxytony/"> Instagram</a> <a className="link" href="https://www.linkedin.com/in/acruzmacedo/"> LinkedIn</a> <a className="link" href="https://open.spotify.com/user/3p6e4kte4mf77mujwzlgs6trw?si=b137c414428a4f00">Spotify</a>
                    </p>
                </div>
            </div>
        </div>
        <div>
            ...
            <h3 className="about-me-p">
                My name is Anthony and I'm a sophomore at the University of Illinois studying Computer Engineering. I am an 
                Academy Member in Hack4Impact and on the MemberSHPE Committee in the Society of Hispanic 
                Professional Engineers. I am excited to build and develop my skills and knowledge during my time at UIUC!
            </h3>
        </div>
