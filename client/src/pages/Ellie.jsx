    ...
    <div className="mainframe" >
      ...
      <div className="welcome">
        ...
        <div className="text">
          ...
          <h6>
            <a href="https://www.instagram.com/ehllieio/">&#9735; instagram</a><br/>
            <a href= "https://read.cv/ellie"> &#9735; cv</a><br/>
      ...
      <p className= "abme-text">&#9733; Hello! My name is Estrella Popoca! &#9733; <br/><br/>
      I'm a freshman @ 
      UIUC pursuing Computer Engineering, <br/>
      and welcome aboard to my adventures here as a future engineer! <br/><br/>
      I like to hang out with friends, watch thriller shows, and percy jackson! 
      <br/><br/>
      My philosophy: Never turning down a friendhsip. 
      <br/><br/>
      I love rice. Any rice. </p><br/><br/>
